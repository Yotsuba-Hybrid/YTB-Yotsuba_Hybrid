...
//+:cnd:noEmit
        ...
        {
            SystemRegistry sr = new SystemRegistry();
            sr.LoadAllCustomSystems();
        ...
        protected override void LoadContent()
        {
            try
            {
                YTBGlobalState.GumProjectSave = GumService.Default.Initialize(this, "GumProject/GumProject.gumx");
            }
            catch (Exception ex)
            {
                throw;
